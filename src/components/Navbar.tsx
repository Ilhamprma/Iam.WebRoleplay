...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 h-14 bg-white/90 dark:bg-[#08090d]/90 backdrop-blur-md border-b border-slate-200 dark:border-white/[0.08] px-4 md:px-6 flex items-center justify-between transition-colors">
